 ...
 * <ul>
 * <li>The first rule says that if the user requests the URL '/path/to/sell.php/articles',
 *   it should be treated as '/path/to/sell.php/article/list'; and vice versa applies
 ...
 *   '/path/to/sell.php/article/13', it should be treated as '/path/to/sell.php/article/read?id=13';
 ...
 * For example, using the rules above, the URL '/sell.php/post/123/create'
