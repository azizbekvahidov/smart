...
<a class="btn btn-success" href="test?id=<?=$val["actregisterId"]?>">Скачать в Еxcel</a>
<a href="closeAct?id=<?=$val["actregisterId"]?>" class="closeAct btn btn-danger right" onclick="javascript:;" ><i class="glyphicon glyphicon-remove"> </i> Закрыть акт</a>
<script>
    ...
    $(document).on("click",".detailSave", function () {
        $.ajax({
            type: "POST",
            url: "<?php echo Yii::app()->createUrl('admin/addActLabDetail'); ?>",
                ...
                <form action="" class="detailForm">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="code" placeholder="Код" class="placeholder form-control">
                            </td>
                            <td>
                            </td>
                            <td>
